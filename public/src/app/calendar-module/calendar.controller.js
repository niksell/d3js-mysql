    ...
    function CalendarController($scope, $rootScope, $mdDialog, $mdToast, $filter, $element, triTheming, triLayout, uiCalendarConfig) {
        ...
        vm.calendarOptions = {
            ...
            eventClick: function(calEvent, jsEvent, view) { //eslint-disable-line
                $mdDialog.show({
                    controller: 'EventCalendarDialogController',
                    controllerAs: 'vm',
                    templateUrl: 'app/calendar-module/event-Calendardialog.tmpl.html',
                    targetEvent: jsEvent,
                    focusOnOpen: false,
                    locals: {
                        dialogData: {
        ...
        function addEvent(event, $event) {
            ...
            $mdDialog.show({
                ...
                controllerAs: 'vm',
                templateUrl: 'app/calendar-module/event-dialog.tmpl.html',
                targetEvent: $event,
                focusOnOpen: false,
                locals: {
                    dialogData: {
        ...
        function createRandomEvents(number, startDate, endDate) {
            ...
            for(var x = 0; x < number; x++) {
                ...
                vm.eventSources[0].events.push({
                    title: 'Activity',//eventNames[randomEvent],
                    allDay: false,
                    start: randomMonthDate,
                    end: inAnHour,
                    description: 'tooristas.com',
                    location: 'Greece',//locationNames[randomLocation],
