(function() {
    ...
    function moduleConfig($stateProvider, triMenuProvider) {
        ...
        .state('triangular.calendar', {
            ...
            views: {
                '@triangular': {
                    ...
                    templateUrl: 'app/calendar-module/calendar.tmpl.html',
                    // set the controller to load for this page
                    controller: 'CalendarController',
                    controllerAs: 'vm'
                },
                'toolbar@triangular': {
                    templateUrl: 'app/calendar-module/layouts/toolbar/toolbar.tmpl.html',
                    controller: 'CalendarToolbarController',
                    controllerAs: 'vm'
                },
                'belowContent@triangular': {
                    templateUrl: 'app/calendar-module/calendar-fabs.tmpl.html',
            ...
            data: {
                ...
                permissions: {
                    only: ['viewCalendar','viewMyBusiness']
                }
            }
        });
        ...
        triMenuProvider.addMenu({
            ...
            priority: 2.3,
            permission: ['viewCalendar','viewMyBusiness'],
        });
    }
})();
